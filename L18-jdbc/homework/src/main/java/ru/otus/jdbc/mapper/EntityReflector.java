...
public class EntityReflector<T> {
    ...
    public Object getFieldValue(Field fld, T obj)
            throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        var getter = "get" + fld.getName().substring(0, 1).toUpperCase()
    ...
    public List<Object> getFieldsValue(List<Field> flds, T obj)
